interface Resources {
  "en-US": {
    ...
    "account.transactionSummary.addLiquidityv2": "Add <baseAmountAndToken /> and <quoteAmountAndToken /> to Uniswap V2",
    "account.transactionSummary.approve": "Approve {{tokenSymbol}}",
    "account.transactionSummary.claimFor": "Claim <currency /> for {{username}}",
    ...
    "account.transactionSummary.removeLiquiditySummary": "Remove <base /> and <quote />",
    "account.transactionSummary.revoke": "Revoke {{tokenSymbol}}",
    "account.transactionSummary.sendSummary": "Sent <amount /> to {{recipient}}",
    "account.transactionSummary.submitProposal": "Submit new proposal",
    "account.transactionSummary.swapExactIn": "Swap exactly <amount1 /> for <amount2 />",
    "account.transactionSummary.swapExactOut": "Swap <amount1 /> for exactly <amount2 />",
    "account.transactionSummary.unwrapTo": "Unwrap <amount /> to {{symbol}}",
    ...
    "account.transactionSummary.wrapTo": "Wrap <amount /> to {{symbol}}",
    ...
    "activity.transaction.swap.descriptor.formatted": "<amountWithSymbolA /> for <amountWithSymbolB />",
    "activity.transaction.tokens.descriptor": "{{amountWithSymbolA}} and {{amountWithSymbolB}}",
    "activity.transaction.tokens.descriptor.formatted": "<amountWithSymbolA /> and <amountWithSymbolB />",
    ...
    "claim.thanks": "Thanks for being part of the Uniswap community <heart />",
    ...
    "common.availableIn": "Uniswap available in: <locale />",
    ...
    "common.blocked.reason": "This address is blocked on the Uniswap Labs interface because it is associated with one or more <link>blocked activities</link>.",
    ...
    "common.checkNetwork": "Check network status <link>here.</link>",
    ...
    "downloadApp.modal.alreadyHaveWallet": "Already have a wallet? <signInHere/>",
    ...
    "explore.search.empty.full": "No results found for <highlight>\"{{searchQuery}}\"</highlight>",
    ...
    "hero.swap.title": "Swap anytime, <br/> anywhere.",
    ...
    "limits.form.disclaimer.uniswapx": "Limits may not execute exactly when tokens reach the specified price. <link />",
    ...
    "liquidityPool.positions.price.formatted": "<amountWithSymbol /> per <outputToken />",
    ...
    "migrate.missingV2Position": "Don’t see one of your v2 positions? <link>Import it.</link>",
    ...
    "migrate.priceWarning": "You should only deposit liquidity into Uniswap V3 at a price you believe is correct. <br /> If the price seems incorrect, you can either make a swap to move the price or wait for someone else to do so.",
    ...
    "migrate.v2Description": "This tool will safely migrate your {{source}} liquidity to V3. The process is completely trustless thanks to the <0>Uniswap migration contract</0> ↗",
    ...
    "nav.tabs.createV4Position": "Create V4 position",
    ...
    "nft.card.notAvailable": "Content not <br /> available yet",
    ...
    "onboarding.home.intro.bridging.description_one": "Move ETH, USDC, and more across {{count}}+ networks.",
    "onboarding.home.intro.bridging.description_other": "Move ETH, USDC, and more across {{count}}+ networks.",
    ...
    "pool.claimFees.button.label": "Claim",
    ...
    "qrScanner.wallet.title": "You can send and receive tokens and NFTs on all of our {{numOfNetworks}} supported networks.",
    ...
    "revoke.failed.message": "This provides the Uniswap protocol access to your token for trading.",
    ...
    "swap.button.swapAnyways": "Swap anyways",
    ...
    "swap.form.pocketUniverseExtension.warning": "The Pocket Universe extension violates our <termsLink /> by modifying our product in a way that is misleading and could harm users. Please disable the extension and reload the page.",
    ...
    "swap.warning.priceImpact": "This transaction will result in a <impact /> price impact on the market price of this pool. Do you wish to continue?",
    ...
    "transaction.confirmation.completionTime_one": "Transaction completed in <highlight>{{count}}</highlight> second 🎉",
    "transaction.confirmation.completionTime_other": "Transaction completed in <highlight>{{count}}</highlight> seconds 🎉",
    ...
    "transaction.warning.insufficientGas.modal.message": "You need ~{{tokenAmount}} {{tokenSymbol}} (<fiatTokenAmount/>) on {{networkName}} to cover this transaction’s network cost.",
    ...
    "uniswapX.aggregatesLiquidity": "<logo /> aggregates liquidity sources for better prices and gas free swaps.",
    ...
    "uniswapx.item": "<icon /> <gradient>UniswapX</gradient> <info />",
    ...
    "walletConnect.dapps.connection": "<highlight>Connected to </highlight>{{dappNameOrUrl}}",
